...
public class MetodosTuberia {
    ...
    public static void cargarTuberiasDesde(ArbolAVL arbol, Grafo caminos, HashMap<TuberiaKey, Tuberia> tuberias) throws IOException {
    ...
    public static void obtenerCaminoDeCaudalPlenoMinimo(ArbolAVL ciudades, Grafo caminos, HashMap<TuberiaKey, Tuberia> tuberias) {
        ...
        if (ciudadOrigen != null) {
            ...
            if (ciudadDestino != null) {
                ...
                if (!todosLosCaminos.esVacia()) {
                    // Verifica que la ciudad origen y destino no sea la misma. Si la primer lista de los caminos tiene
                    // una sola ciudad, significa que la ciudad origen y destino son las mismas y no hay ningún camino
    ...
    private static Lista buscarCaminoDeCaudalPlenoMinimo(Lista caminos, HashMap<TuberiaKey, Tuberia> tuberias) {
        ...
        while (pos <= longitud) { 
            ...
            // Verifica que el caudal de la tubería con el diametro más pequeño del camino, sea más pequeño que el
            // caudal de la tubería con el diametro más pequeño de un camino encontrado hasta ahora
    ...
    private static Tuberia tuberiaDiametroMasPequenio(Lista camino, HashMap<TuberiaKey, Tuberia> tuberias) {
        ...
        while (pos2 <= longitud) {
            ...
            // Verifica que el diametro de la tuberia sea más pequeño que el diametro más pequeño encontrado hasta ahora o
    ...
    private static Tuberia obtenerTuberia(Lista camino, int pos1, int pos2, HashMap<TuberiaKey, Tuberia> tuberias) {
        ...
        // Se obtienen las nomenclaturas de las ciudades para obtener la tubería que las conecta en el HashMap
    ...
    private static String obtenerEstadoCamino(Lista caminoMasCorto, HashMap<TuberiaKey, Tuberia> tuberias){
        ...
        longitud = caminoMasCorto.longitud(); // Se guarda la longitud para no estar calculandola constantemente en el while
        ...
        while (pos2 <= longitud && !terminar) {
            ...
            switch (tuberia.getEstado()) {
                case Estado.DISENIO -> {
                    // Si una tubería está en diseño, todo el camino está en diseño y se termina el bucle
                    estado = "EN DISENIO";
                    terminar = true;
                }
                ...
                case Estado.REPARACION -> {
                    // El estado actual del camino está en reparación, siempre y cuando no se haya encontrado una tubería inactiva
